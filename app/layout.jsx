...
export const metadata = {
  ...
  description:
    "Performance Marketer, SEO Analyst, and Web Developer specializing in high-converting ad channels (Meta, Google Ads) and high-performance web solutions.",
  ...
  authors: [
    { name: "S. Fahath", url: "https://fahath-s-digital-marketer.vercel.app" },
  ],
  creator: "S. Fahath",
  publisher: "S. Fahath",
  robots: {
  ...
  openGraph: {
    ...
    description:
      "Explore the performance marketing, SEO, and web development craftsmanship of S. Fahath. High-performance, data-driven systems wrapped in an eye-comfort vintage editorial style.",
  ...
  icons: {
    ...
    apple: [{ url: "/logo-v2.webp", type: "image/webp" }],
  },
  verification: {
    ...
    "@graph": [
      {
        ...
        description:
          "SEO Analyst, Performance Marketer, and Web Developer specializing in Google Ads, Meta Ads, and bespoke web solutions.",
        publisher: {
  ...
  return (
    <html lang="en">
      <head>
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,300..800;1,300..800&family=Inter:ital,wght@0,300..900;1,300..900&display=swap"
        />
